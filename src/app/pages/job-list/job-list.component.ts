...
export class JobListComponent implements OnInit {
  ...
  applyJob(job: any): void {
    ...
    // For example, you can add the job to a cart or send an application email
  }

  deleteJob(jobId: number): void {
    console.log('Deleting job:', jobId);
    // Add logic to delete the job here
    // For example, you can remove the job from the jobs array
